...
# Tiled YUV formats
V4L2_PIX_FMT_NV12_4L4 = v4l2_fourcc("V", "T", "1", "2")  # 12  Y/CbCr 4:2:0  4x4 tiles
V4L2_PIX_FMT_NV12_16L16 = v4l2_fourcc(
    "H", "M", "1", "2"
)  # 12  Y/CbCr 4:2:0 16x16 tiles
V4L2_PIX_FMT_NV12_32L32 = v4l2_fourcc(
    "S", "T", "1", "2"
)  # 12  Y/CbCr 4:2:0 32x32 tiles

# Tiled YUV formats, non contiguous planes
V4L2_PIX_FMT_NV12MT = v4l2_fourcc("T", "M", "1", "2")  # 12  Y/CbCr 4:2:0 64x32 tiles
V4L2_PIX_FMT_NV12MT_16X16 = v4l2_fourcc(
    "V", "M", "1", "2"
)  # 12  Y/CbCr 4:2:0 16x16 tiles
V4L2_PIX_FMT_NV12M_8L128 = v4l2_fourcc("N", "A", "1", "2")  # Y/CbCr 4:2:0 8x128 tiles
...
V4L2_PIX_FMT_CIT_YYVYUY = v4l2_fourcc(
    "C", "I", "T", "V"
...
V4L2_PIX_FMT_S5C_UYVY_JPG = v4l2_fourcc(
    "S", "5", "C", "I"
...
V4L2_PIX_FMT_IPU3_SBGGR10 = v4l2_fourcc(
    "i", "p", "3", "b"
)  # IPU3 packed 10-bit BGGR bayer
V4L2_PIX_FMT_IPU3_SGBRG10 = v4l2_fourcc(
    "i", "p", "3", "g"
)  # IPU3 packed 10-bit GBRG bayer
V4L2_PIX_FMT_IPU3_SGRBG10 = v4l2_fourcc(
    "i", "p", "3", "G"
)  # IPU3 packed 10-bit GRBG bayer
V4L2_PIX_FMT_IPU3_SRGGB10 = v4l2_fourcc(
    "i", "p", "3", "r"
